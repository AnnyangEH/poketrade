...
const TRANSLATIONS = {
  ko: {
    ...
    alertDateRange: '날짜는 2016년~2036년 사이로 입력해주세요.',
    ...
    confirmDeleteCompleted: buyer => `${buyer}님과의 완료된 교환 기록을 삭제하시겠습니까?\n→ 보관함에서 줄 포켓몬 수량이 1개 복구됩니다.`,
  ...
  en: {
    ...
    checkFriendLucky: 'Friend',
    checkLuckyTrade: 'Lucky Trade',
    ...
    upcomingTitle: 'Scheduled Exchanges',
    ...
    alertDateRange: 'Please enter a date between 2016 and 2036.',
    ...
    confirmDeleteCompleted: buyer => `Delete the completed exchange record with ${buyer}?\n→ 1 will be restored to the given Pokémon's inventory.`,
